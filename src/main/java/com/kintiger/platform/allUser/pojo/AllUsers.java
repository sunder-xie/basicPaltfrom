...
public class AllUsers extends SearchInfo {
	...
	public String toString() {
		return "AllUsers [userId=" + userId + ", passWd=" + passWd
				+ ", userName=" + userName + ", userShowName=" + userShowName
				+ ", userState=" + userState + ", custType=" + custType
				+ ", loginId=" + loginId + ", mobile=" + mobile
				+ ", mobileSimple=" + mobileSimple + ", empShortmsgbook="
				+ empShortmsgbook + ", smsUserTypeId=" + smsUserTypeId
				+ ", chargeId=" + chargeId + ", phone=" + phone
				+ ", busMobilephone=" + busMobilephone + ", hqSign=" + hqSign
				+ ", kunnrSign=" + kunnrSign + ", isOffice=" + isOffice
				+ ", paswdSignDate=" + paswdSignDate + ", orgId=" + orgId
				+ ", orgName=" + orgName + ", idCard=" + idCard + ", workFax="
				+ workFax + ", homePhone=" + homePhone + ", startDate="
				+ startDate + ", address=" + address + ", email=" + email
				+ ", sex=" + sex + ", posName=" + posName + ", posId=" + posId
				+ ", haveMail=" + haveMail + ", remark=" + remark
				+ ", positionTypeName=" + positionTypeName + ", orgIds="
				+ Arrays.toString(orgIds) + ", id=" + id + ", orgStr=" + orgStr
				+ ", supplierNumber=" + supplierNumber + ", questionLinkId="
				+ questionLinkId + ", reason=" + reason + ", roleIds="
				+ roleIds + ", stationState=" + stationState + ", ids=" + ids
				+ ", userIds=" + Arrays.toString(userIds) + ", empPostId="
				+ empPostId + ", empPostName=" + empPostName + ", expressly="
				+ expressly + ", stationNames=" + stationNames + ", ip=" + ip
				+ ", allOrg=" + Arrays.toString(allOrg) + ", expiredpsw="
				+ expiredpsw + ", staffNubmer=" + staffNubmer + ",rtx_LoginId="+rtx_LoginId+"]";
	}

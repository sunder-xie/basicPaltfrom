package com.kintiger.platform.evtstatistics.dao;

import java.util.List;

import com.kintiger.platform.evtstatistics.pojo.Evtstatistics;

public interface EvtstatisticsDao {
	...
	public List<Evtstatistics> searchEventModelForCsv(Evtstatistics evtstatistics);
	...
	public List<Evtstatistics> searchEventModelHrRoles(Evtstatistics evtstatistics);
	public int searchEventModelHrListCount(Evtstatistics evtstatistics);
	public List<Evtstatistics> searchEventModelHrList(Evtstatistics evtstatistics);
	public List<Evtstatistics> searchEventModelHrDetailList(Evtstatistics evtstatistics);
	...
	public List<Evtstatistics> searchHrOverTimeEvtDtlList(Evtstatistics evtstatistics);
	public int searchSendEmailDateCount();
	public int createSendEmailDate();
	public List<Evtstatistics> searchOverTimeEvtDtlForEmail(Evtstatistics evtstatistics);
}
